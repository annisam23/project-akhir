              ...
              <div id="storeCarousel" class="carousel slide" data-ride="carousel">
                ...
                <div class="carousel-inner">
                  <div class="carousel-item active">
                    <img src="<?php echo base_url(); ?>public/images/banner2.jpg" class="d-block w-100" alt="Carousel Image" />
                  </div>
                  <div class="carousel-item">
                    <img src="<?php echo base_url(); ?>public/images/banner.jpg" class="d-block w-100" alt="Carousel Image" />
                  </div>
                  <div class="carousel-item">
                    <img src="<?php echo base_url(); ?>public/images/banner1.jpg" class="d-block w-100" alt="Carousel Image" />
                  </div>
                </div>
              </div>
            </div>
        ...
        <div class="container">
          ...
          <div class="row">
            <div class="col-6 col-md-3 col-lg-2" data-aos="fade-up" data-aos-delay="100">
              <a class="component-categories d-block" href="#">
                <div class="categories-image">
                  <img src="<?php echo base_url(); ?>public/images/categories-rs.svg" alt="Rumah Sakit" class="w-100" />
                </div>
            ...
            <div class="col-6 col-md-3 col-lg-2" data-aos="fade-up" data-aos-delay="200">
              <a class="component-categories d-block" href="#">
                <div class="categories-image">
                  <img src="<?php echo base_url(); ?>public/images/categories-klinikumum.svg" alt="Klinik Umum" class="w-100" />
                </div>
            ...
            <div class="col-6 col-md-3 col-lg-2" data-aos="fade-up" data-aos-delay="300">
              <a class="component-categories d-block" href="#">
                <div class="categories-image">
                  <img src="<?php echo base_url(); ?>public/images/categories-apotek.svg" alt="Apotek" class="w-100" />
                </div>
            ...
            <div class="col-6 col-md-3 col-lg-2" data-aos="fade-up" data-aos-delay="400">
              <a class="component-categories d-block" href="#">
                <div class="categories-image">
                  <img src="<?php echo base_url(); ?>public/images/categories-tooth.svg" alt="Klinik Gigi" class="w-100" />
                </div>
            ...
            <div class="col-6 col-md-3 col-lg-2" data-aos="fade-up" data-aos-delay="500">
              <a class="component-categories d-block" href="#">
                <div class="categories-image">
                  <img src="<?php echo base_url(); ?>public/images/categories-puskesmas.svg" alt="Puskesmas" class="w-100" />
                </div>
            ...
            <div class="col-6 col-md-3 col-lg-2" data-aos="fade-up" data-aos-delay="600">
              <a class="component-categories d-block" href="#">
                <div class="categories-image">
                  <img src="<?php echo base_url(); ?>public/images/categories-more.svg" alt="Lainnya" class="w-100" />
                </div>
